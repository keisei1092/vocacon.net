...
<body>
  ...
  <header id="top" class="header">
    <div class="text-vertical-center">
      ...
      <div class="mt_5 f_42 mb-f_14 italic">歌声合成に関わる"<span class="txt-pink">最新</span>"が集うファンイベント</div>
      <div class="mt_20 f_30 mb-f_14">2016.10.<span class="f_42 mb-f_14">29</span>(<span class="txt-blue">Sat</span>) - <span class="f_42 mb-f_14">30</span>(<span class="txt-pink">Sun</span>)</div>
      <div class="mt_5 f_36 mb-f_14">ヤマハリゾートつま恋(静岡県掛川市)</div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-vertical-center">
          <h1>歌唱合成に関わる最新が集う<br>総合文化祭的ファンイベント！</h1><br>
          <p class="lead">VOCACON&trade;は、VOCALOID&reg;<sup>※</sup>、UTAU、Sinsyといった歌唱合成技術やその派生文化のファンが企画を持ち寄り楽しむ、一泊二日（日帰り参加もあり）のコンベンション形式イベントです。開催される企画はオールジャンル・オールカテゴリ。歌唱合成に関する企画なら何でもアリの二日間です。</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="contact" class="map" onclick="document.getElementById('iframe').style.pointerEvents= 'auto'">
    <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13110.255675487952!2d138.05374768132413!3d34.766576387097196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601af82ecd45035f%3A0xc17d1bbf6b26d450!2z44Ok44Oe44OP44Oq44K-44O844OI44Gk44G-5oGL!5e0!3m2!1sja!2sjp!4v1470571042860" id="iframe"></iframe>
  </section>
  <footer>
    <div class="container">
      <div class="row">
